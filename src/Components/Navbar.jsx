        ...
        <div className="w-full flex justify-center mt-3 sm:mt-4">
          ...
          >
            ...
            <div className="hidden lg:flex items-center justify-end gap-8 pr-6 lg:pr-24">
              ...
              {/* NEW: Trust & Care Overview nav item (keeps design & spacing intact) */}
              <NavLink to="/trust-care" className={activeStyles}>
                {t("navbar.trustCare", "Trust & Care Overview")}
              </NavLink>
            </div>
            ...
            <aside className="fixed top-0 left-0 z-50 h-full w-72 max-w-[85%] bg-white shadow-xl ring-1 ring-black/5">
              ...
              <nav className="px-3 py-4">
                <ul className="space-y-1">
                  ...
                  {/* NEW: Trust & Care Overview in mobile sidebar */}
                  <li>
                    <NavLink
                      to="/trust-care"
                      className={({ isActive }) =>
